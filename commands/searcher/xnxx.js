...
module.exports = {
    ...
    callback: async ({ msg, fullArgs }) => {
        let xxx = await axios.get('https://api.botcahx.live/api/search/xnxx?query={query}&apikey=DeHBriJv'.format({ query: fullArgs })).catch(() => { return msg.reply('tidak ditemukan') })
